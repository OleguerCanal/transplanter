...
from src.utilities.visualizer import visualize_tensor
...
def print_weights(model):
    ...
    visualize_tensor(state_dict["out_layer_2.weight"])
...
if __name__ == "__main__":
    ...
    small_conv_net_path = "test_models/trained_models/small.ckpt"
    teacher_args = {"hidden_dim": 64, "flattened_size": 1024}
    teacher_model = SmallConvNet.load_from_checkpoint(checkpoint_path=small_conv_net_path,
                                                      **teacher_args)
